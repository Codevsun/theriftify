      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto">
            <!-- Left side of navbar -->
            <li class="nav-item">
              <a href="Women.html" class="nav-link"
            ...
            <li class="nav-item">
              <a href="../admin/sign_in.html" class="nav-link"
            ...
            <li class="nav-item">
              <a href="shoppingcart.html" class="nav-link"
                ><i class="bi bi-bag" style="margin-right: 20px"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
            ...
            <li class="nav-item">
              <a href="pastPurchuses.html" class="nav-link"
                ><i class="bi bi-bag" style="margin-right: 20px"
                  ><svg
                    width="15"
                    height="15"
